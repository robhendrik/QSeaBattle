...
3. [Self-training of a neural-net-based player](html/Tutorial_DIAL_DRU_training_neural_net_models.html)

4. [Imitation training of a player using post-quantum resources with the "linear" model](html/Tutorial_LinTrainableAssisted_Imitation.html)

5. [Imitation training of a player using post-quantum resources with the "pyramid" model](html/Tutorial_PyrTrainableAssisted_Imitation.html)
