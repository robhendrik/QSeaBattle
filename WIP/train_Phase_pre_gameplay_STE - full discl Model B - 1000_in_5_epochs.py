...
#
# Now also modifief Comm_b to next_comm_logit = self._dense_comm(h, training=training) + comm_batch
# [epoch 13] Training mode: B
# epoch 013  total=0.0122  shoot_acc=1.0000  comm_a_loss=0.0000  meas_in_a_loss=0.0001  comms_b_loss=0.0059  shoot_loss=0.0003  comm_mag_loss=0.0019  comm_mag_loss_raw=19.4979  mean_abs_comm_for_b=14.1137  meas_mag_loss=0.0025  meas_mag_loss_raw=25.2056  mean_abs_meas_in_a=12.9780  meas_b_mag_loss=0.0015  meas_b_mag_loss_raw=15.3279  mean_abs_meas_b=9.0379  mean_abs_gun_logits=8.0013  comm_mag_beta_target=10.0000  w_comm_mag=0.0001  w_meas_mag=0.0001  w_meas_b_mag=0.0001  lambda_harden=0.0000  lr_a*1000=0.0100  lr_b*1000=0.1000  meas_in_a_per_0=0.0000  meas_in_a_per_1=0.0001  meas_in_a_per_2=0.0001  meas_in_a_per_3=0.0000  comms_b_per_0=0.0117  comms_b_per_1=0.0047  comms_b_per_2=0.0012

# [weights] saved: model_a_best.weights.h5, model_b_best.weights.h5

# [epoch 14] Training mode: B
# [train] interrupted by user.
# [log] flushed -> C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260319_103700.pkl
# [weights] saved: model_a_epoch_0014_interrupted.weights.h5, model_b_epoch_0014_interrupted.weights.h5
# [weights] saved: model_a_latest.weights.h5, model_b_latest.weights.h5
# {'log_path': 'C:\\Users\\nly99857\\OneDrive - Philips\\SW Projects\\QSeaBattle\\WIP\\logs\\train_run_20260319_103700.pkl', 'epochs_recorded': 14, 'interrupted': True}
#
# Start with model without loading any weights
#
# Does not kick off quickly
#
# try staring with step 2 and only AB training
#
#
# Set P_HIGH to 0.95: train_run_20260319_140042.pkl ~ 81%
# Set P_HIGH to 0.9: train_run_20260319_152346.pkl ~ 68% also train_run_20260319_173419.pkl 1000 epochs ~ 68%
# Change combine B to new version
# also train_run_20260319_173419.pkl 1000 epochs ~ 68%
# Change PR_LAYER dealing with P_HIGH to make gradient backpropagate
# ==> Also stall s at 68% and does not improve with more epochs. train_run_20260320_064055.pkl 
# 
# Now try phigh = 1.0 for the new combine b AND pr assisted layers.
# Reaches 1.0000 after 13 epochs, saved as step30, train_run_20260320_070437.pkl (ALPHA = 0.3)
# 
# Move to 500k dataset, move back to SR layer without STE.
# 
# [epoch 5] Training mode: B
# epoch 005  total=0.0113  shoot_acc=1.0000  comm_a_loss=0.0000  meas_in_a_loss=0.0001  comms_b_loss=0.0052  shoot_loss=0.0002  comm_mag_loss=0.0020  comm_mag_loss_raw=20.3904  mean_abs_comm_for_b=14.2411  meas_mag_loss=0.0023  meas_mag_loss_raw=22.6889  mean_abs_meas_in_a=12.8785  meas_b_mag_loss=0.0015  meas_b_mag_loss_raw=14.6036  mean_abs_meas_b=9.0560  mean_abs_gun_logits=8.0318  comm_mag_beta_target=10.0000  w_comm_mag=0.0001  w_meas_mag=0.0001  w_meas_b_mag=0.0001  lambda_harden=0.0000  lr_a*1000=0.0100  lr_b*1000=0.1000  meas_in_a_per_0=0.0000  meas_in_a_per_1=0.0002  meas_in_a_per_2=0.0001  meas_in_a_per_3=0.0000  comms_b_per_0=0.0107  comms_b_per_1=0.0040  comms_b_per_2=0.0010
# saved as checkpoint step21, train_run_20260320_143910.pkl
# 
# # "c:/Users/nly99857/OneDrive - Philips/SW Projects/QSeaBattle/WIP/train_Phase_pre_gameplay_STE - full discl Model B.py"
# Dataset loaded and training pipeline built: C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\dataset_500k
# Building model A with config: field_size=4, comms_size=1, p_high=1.0, beta_input=10.0, seed=42       
# Building model B with config: field_size=4, comms_size=1, p_high=1.0, beta_input=10.0
# [weights] loaded: model_a_step2.weights.h5, model_b_step2.weights.h5
# [log] run file: C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260320_143910.pkl
