...
This module defines :class:`PyrMeasurementLayerB`, a small trainable Keras layer used in
...
- gun_batch: tf.Tensor, shape (B, L)  (cropped; L is the active width L_d)
...
class PyrMeasurementLayerB(tf.keras.layers.Layer):
    """Trainable layer mapping gun state -> measurement logits."""
