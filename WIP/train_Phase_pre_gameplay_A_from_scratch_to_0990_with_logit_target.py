...
#  Does not work. Is this due to w_comms_a=0.0 or w_comm_mag=0.0001? 
# [weights] loaded: model_a_step2.weights.h5, model_b_step2.weights.h5
# [log] run file: C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260314_124041.pkl
# Enable rollback:  False

# [epoch 0] Starting epoch with lambda_harden=0.0000
# WARNING: All log messages before absl::InitializeLog() is called are written to STDERR
# W0000 00:00:1773488455.740870   37536 loop_optimizer.cc:934] Skipping loop optimization for Merge node with control input: cond/StatefulPartitionedCall/cond_0/branch_executed/_292
# epoch 000  total=0.1801  shoot_acc=0.9373  comm_a_loss=0.0000  meas_in_a_loss=0.0000  comms_b_loss=0.0898  shoot_loss=0.0889  comm_mag_loss=0.0014  comm_mag_loss_raw=14.0247  mean_abs_comm_for_b=13.5421  meas_mag_loss=0.0000  meas_mag_loss_raw=188.6731  mean_abs_meas_in_a=14.1013  comm_mag_beta_target=1.0000  w_comm_mag=0.0001  w_meas_mag=0.0000  lambda_harden=0.0000  lr_a*1000=0.1000  lr_b*1000=0.2000  meas_in_a_per_0=0.0000  meas_in_a_per_1=0.0000  meas_in_a_per_2=0.0000  meas_in_a_per_3=0.0000  comms_b_per_0=0.0923  comms_b_per_1=0.0886  comms_b_per_2=0.0886   
#
# [epoch 278] Starting epoch with lambda_harden=0.0000
# epoch 278  total=0.0885  shoot_acc=0.9690  comm_a_loss=0.0000  meas_in_a_loss=0.0000  comms_b_loss=0.0446  shoot_loss=0.0435  comm_mag_loss=0.0005  comm_mag_loss_raw=5.1084  mean_abs_comm_for_b=10.4456  meas_mag_loss=0.0000  meas_mag_loss_raw=1001.8125  mean_abs_meas_in_a=30.3680  comm_mag_beta_target=1.0000  w_comm_mag=0.0001  w_meas_mag=0.0000  lambda_harden=0.0000  lr_a*1000=0.1000  lr_b*1000=0.2000  meas_in_a_per_0=0.0000  meas_in_a_per_1=0.0000  meas_in_a_per_2=0.0000  meas_in_a_per_3=0.0000  comms_b_per_0=0.0461  comms_b_per_1=0.0437  comms_b_per_2=0.0438   


# [epoch 279] Starting epoch with lambda_harden=0.0000
# [train] interrupted by user.
# [log] flushed -> C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260314_124041.pkl
# [weights] saved: model_a_epoch_0279_interrupted.weights.h5, model_b_epoch_0279_interrupted.weights.h5
# [weights] saved: model_a_latest.weights.h5, model_b_latest.weights.h5
# {'log_path': 'C:\\Users\\nly99857\\OneDrive - Philips\\SW Projects\\QSeaBattle\\WIP\\logs\\train_run_20260314_124041.pkl', 'epochs_recorded': 279, 'interrupted': True}
#
# Run with  w_comms_a=0.05, w_comm_mag=float(0.0001)
# [epoch 879] Starting epoch with lambda_harden=0.9900
# epoch 879  total=3.3286  shoot_acc=0.9864  comm_a_loss=0.0016  meas_in_a_loss=0.0072  comms_b_loss=0.0766  shoot_loss=0.0489  comm_mag_loss=3.1943  comm_mag_loss_raw=31943.0957  mean_abs_comm_for_b=11.3653  meas_mag_loss=0.0000  meas_mag_loss_raw=1712.6539  mean_abs_meas_in_a=33.2635  comm_mag_beta_target=1.0000  w_comm_mag=0.0001  w_meas_mag=0.0000  lambda_harden=0.9900  lr_a*1000=0.1000  lr_b*1000=0.2000  meas_in_a_per_0=0.0000  meas_in_a_per_1=0.0020  meas_in_a_per_2=0.0101  meas_in_a_per_3=0.0166  comms_b_per_0=0.1138  comms_b_per_1=0.0601  comms_b_per_2=0.0560


# [epoch 880] Starting epoch with lambda_harden=0.9900
# [train] interrupted by user.
# [log] flushed -> C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260314_213940.pkl
# [weights] saved: model_a_epoch_0880_interrupted.weights.h5, model_b_epoch_0880_interrupted.weights.h5
# [weights] saved: model_a_latest.weights.h5, model_b_latest.weights.h5
# {'log_path': 'C:\\Users\\nly99857\\OneDrive - Philips\\SW Projects\\QSeaBattle\\WIP\\logs\\train_run_20260314_213940.pkl', 'epochs_recorded': 880, 'interrupted': True}
