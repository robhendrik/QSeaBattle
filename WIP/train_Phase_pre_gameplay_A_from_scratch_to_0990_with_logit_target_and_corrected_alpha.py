# Start from step2 and et alpha to 0.5
# [weights] loaded: model_a_step2.weights.h5, model_b_step2.weights.h5
# [log] run file: C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260316_082913.pkl
# Enable rollback:  False

# [epoch 0] Starting epoch with lambda_harden=0.0000
# WARNING: All log messages before absl::InitializeLog() is called are written to STDERR
# W0000 00:00:1773646166.997349   20736 loop_optimizer.cc:934] Skipping loop optimization for Merge node with control input: cond/StatefulPartitionedCall/cond_0/branch_executed/_292
# epoch 000  total=0.1835  shoot_acc=0.9377  comm_a_loss=0.0000  meas_in_a_loss=0.0000  comms_b_loss=0.0904  shoot_loss=0.0916  comm_mag_loss=0.0014  comm_mag_loss_raw=14.3167  mean_abs_comm_for_b=13.5950  meas_mag_loss=0.0000  meas_mag_loss_raw=166.7861  mean_abs_meas_in_a=13.2332  comm_mag_beta_target=1.0000  w_comm_mag=0.0001  w_meas_mag=0.0000  lambda_harden=0.0000  lr_a*1000=0.1000  lr_b*1000=0.2000  meas_in_a_per_0=0.0000  meas_in_a_per_1=0.0001  meas_in_a_per_2=0.0001  meas_in_a_per_3=0.0000  comms_b_per_0=0.0936  comms_b_per_1=0.0887  comms_b_per_2=0.0889
#
# epoch 256  total=1.0626  shoot_acc=0.9872  comm_a_loss=0.0016  meas_in_a_loss=0.0057  comms_b_loss=0.0686  shoot_loss=0.0388  comm_mag_loss=0.9479  comm_mag_loss_raw=9479.2744  mean_abs_comm_for_b=10.6823  meas_mag_loss=0.0000  meas_mag_loss_raw=763.1716  mean_abs_meas_in_a=20.9812  comm_mag_beta_target=1.0000  w_comm_mag=0.0001  w_meas_mag=0.0000  lambda_harden=0.9900  lr_a*1000=0.1000  lr_b*1000=0.2000  meas_in_a_per_0=0.0008  meas_in_a_per_1=0.0008  meas_in_a_per_2=0.0062  meas_in_a_per_3=0.0151  comms_b_per_0=0.0660  comms_b_per_1=0.0836  comms_b_per_2=0.0562


# [epoch 257] Starting epoch with lambda_harden=0.9900
# [train] interrupted by user.
# [log] flushed -> C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260316_082913.pkl
# [weights] saved: model_a_epoch_0257_interrupted.weights.h5, model_b_epoch_0257_interrupted.weights.h5
# [weights] saved: model_a_latest.weights.h5, model_b_latest.weights.h5
# {'log_path': 'C:\\Users\\nly99857\\OneDrive - Philips\\SW Projects\\QSeaBattle\\WIP\\logs\\train_run_20260316_082913.pkl', 'epochs_recorded': 257, 'interrupted': True}
...
def build_model_a(config: dict[str, Any]) -> tf.keras.Model:
    ...
    return PyrInternalModelA(
        ...
        p_high=p_high,
        beta=beta_input,
        alpha=0.5, # scale this to |logit| = 10.0
        seed=seed + 10,
    )
