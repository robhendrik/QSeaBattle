# Start from step14 and et alpha to 0.5
# Noise removed (was 0.3 for all 3 channels), STE only on comms, meas_in and meas_out straight through
# W_COMM_MAG set to 0.0
#
# [weights] loaded: model_a_step14.weights.h5, model_b_step14.weights.h5
# [log] run file: C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260316_114912.pkl
# Enable rollback:  False

# [epoch 0] lambda_harden not used
# WARNING: All log messages before absl::InitializeLog() is called are written to STDERR
# W0000 00:00:1773658164.119457   28864 loop_optimizer.cc:934] Skipping loop optimization for Merge node with control input: pr_replay_b_3_1/assert_equal_1/Assert/AssertGuard/branch_executed/_39
# epoch 000  total=0.3810  shoot_acc=0.9404  comm_a_loss=0.0066  meas_in_a_loss=0.0238  comms_b_loss=0.2069  shoot_loss=0.1437  comm_mag_loss=0.0000  comm_mag_loss_raw=10261.6533  mean_abs_comm_for_b=10.0000  meas_mag_loss=0.0000  meas_mag_loss_raw=748.2837  mean_abs_meas_in_a=20.3583  comm_mag_beta_target=1.0000  w_comm_mag=0.0000  w_meas_mag=0.0000  lambda_harden=0.0000  lr_a*1000=0.0500  lr_b*1000=0.1000  meas_in_a_per_0=0.0010  meas_in_a_per_1=0.0009  meas_in_a_per_2=0.0258  meas_in_a_per_3=0.0675  comms_b_per_0=0.2121  comms_b_per_1=0.2136  comms_b_per_2=0.1949
#
# ==> Stalls after a nice spike: train_run_20260316_114912.pkl
# #
#
# Now try iterative B and A training (more B than A, very low A learning rate)
# # [weights] loaded: model_a_step14.weights.h5, model_b_step14.weights.h5
# [log] run file: C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260316_140729.pkl
# Enable rollback:  False

# [epoch 0] Training mode: B
# WARNING: All log messages before absl::InitializeLog() is called are written to STDERR
# W0000 00:00:1773666459.606935   36820 loop_optimizer.cc:934] Skipping loop optimization for Merge node with control input: pr_replay_b_3_1/assert_equal_1/Assert/AssertGuard/branch_executed/_39
# epoch 000  total=1.0658  shoot_acc=0.9765  comm_a_loss=0.0011  meas_in_a_loss=0.0041  comms_b_loss=0.0631  shoot_loss=0.0558  comm_mag_loss=0.9417  comm_mag_loss_raw=9417.1729  mean_abs_comm_for_b=10.0000  meas_mag_loss=0.0000  meas_mag_loss_raw=768.1377  mean_abs_meas_in_a=21.0171  comm_mag_beta_target=1.0000  w_comm_mag=0.0001  w_meas_mag=0.0000  lambda_harden=0.0000  lr_a*1000=0.0100  lr_b*1000=0.1000  meas_in_a_per_0=0.0006  meas_in_a_per_1=0.0007  meas_in_a_per_2=0.0054  meas_in_a_per_3=0.0096  comms_b_per_0=0.0511  comms_b_per_1=0.0694  comms_b_per_2=0.0689
#
# Slow growth to [epoch 17] Training mode: B, epoch 017  total=1.0543  shoot_acc=0.9796 (best so far)
# Then drops when model A training starts at epoch 18-20
#
# #
# Alpha = 0.1, mode=MODE_AB if (epoch%20 < 2) else MODE_B, only comms logits hardened in forward pass.
# [epoch 999] Training mode: B
# epoch 999  total=0.2428  shoot_acc=0.9918  comm_a_loss=0.0028  meas_in_a_loss=0.0079  comms_b_loss=0.0804  shoot_loss=0.0264  comm_mag_loss=0.0955  comm_mag_loss_raw=955.0325  mean_abs_comm_for_b=30.2187  meas_mag_loss=0.0298  meas_mag_loss_raw=298.4994  mean_abs_meas_in_a=14.4444  comm_mag_beta_target=10.0000  w_comm_mag=0.0001  w_meas_mag=0.0001  lambda_harden=0.0000  lr_a*1000=0.0100  lr_b*1000=0.1000  meas_in_a_per_0=0.0000  meas_in_a_per_1=0.0010  meas_in_a_per_2=0.0023  meas_in_a_per_3=0.0283  comms_b_per_0=0.0834  comms_b_per_1=0.0819  comms_b_per_2=0.0760
...
# [weights] saved: model_a_latest.weights.h5, model_b_latest.weights.h5
# {'log_path': 'C:\\Users\\nly99857\\OneDrive - Philips\\SW Projects\\QSeaBattle\\WIP\\logs\\train_run_20260316_153645.pkl', 'epochs_recorded': 1000, 'interrupted': False}
...
def make_train_steps(depth: int):
    ...
    def _core_forward(
        ...
        if mode == MODE_B:
            ...
            comm_logits_for_b = tf.where(comm_fixed >= 0.0, 10.0, -10.0)
            meas_list_for_b = meas_fixed
            out_list_for_b  = out_fixed
        else:
            comm_base = comm_logits
            comm_logits_for_b = comm_base + tf.stop_gradient(
                tf.where(comm_base >= 0.0, 10.0, -10.0) - comm_base
            )
    ...
    try:
        ...
        while epoch < EPOCHS:
            next_stage = _make_stage(
                mode=MODE_AB if (epoch%20 < 2) else MODE_B,
