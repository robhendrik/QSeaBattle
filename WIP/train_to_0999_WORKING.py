...
# [log] run file: C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260314_063703.pkl
# Stage learning rates -> lr_a=9.999999747378752e-05 lr_b=0.00019999999494757503
# WARNING: All log messages before absl::InitializeLog() is called are written to STDERR
# W0000 00:00:1773466633.403306   33720 loop_optimizer.cc:934] Skipping loop optimization for Merge node with control input: cond/StatefulPartitionedCall/cond_0/branch_executed/_292
# epoch 000  total=0.1785  shoot_acc=0.9382  comm_a_loss=0.0000  meas_in_a_loss=0.0000  comms_b_loss=0.0898  shoot_loss=0.0887  lr_a=0.0001  lr_b=0.0002  meas_in_a_per_0=0.0000  meas_in_a_per_1=0.0000  meas_in_a_per_2=0.0000  meas_in_a_per_3=0.0000  comms_b_per_0=0.0921  comms_b_per_1=0.0886  comms_b_per_2=0.0887
#
# saved intermediate as step11, epoch 226, around 98%
# #
# Stage learning rates -> lr_a=9.999999747378752e-05 lr_b=0.00019999999494757503
# epoch 262  total=0.0350  shoot_acc=0.9990  comm_a_loss=0.0000  meas_in_a_loss=0.0001  comms_b_loss=0.0319  shoot_loss=0.0031  lr_a=0.0001  lr_b=0.0002  meas_in_a_per_0=0.0000  meas_in_a_per_1=0.0001  meas_in_a_per_2=0.0001  meas_in_a_per_3=0.0000  comms_b_per_0=0.0789  comms_b_per_1=0.0119  comms_b_per_2=0.0049
...
# [weights] saved: model_a_epoch_0262_final.weights.h5, model_b_epoch_0262_final.weights.h5
# [weights] saved: model_a_latest.weights.h5, model_b_latest.weights.h5
# {'log_path': 'C:\\Users\\nly99857\\OneDrive - Philips\\SW Projects\\QSeaBattle\\WIP\\logs\\train_run_20260314_063703.pkl', 'epochs_recorded': 263, 'interrupted': False}
