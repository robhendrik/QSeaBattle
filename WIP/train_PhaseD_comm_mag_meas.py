# QSeaBattle/venvs/env_QSeaBattle/Scripts/python.exe" "c:/Users/nly99857/OneDrive - Philips/SW Projects/QSeaBattle/WIP/train_PhaseD_comm_mag_meas.py"
# [weights] loaded: model_a_step5.weights.h5, model_b_step5.weights.h5
# [log] run file: C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260310_170244.pkl     
# Stage learning rates -> lr_a=9.999999747378752e-05 lr_b=0.00019999999494757503
# WARNING: All log messages before absl::InitializeLog() is called are written to STDERR
# W0000 00:00:1773158576.746249    5240 loop_optimizer.cc:934] Skipping loop optimization for Merge node with control input: cond/StatefulPartitionedCall/cond_0/branch_executed/_292
# epoch 000  total=6.3926  shoot_acc=0.9637  comm_a_loss=0.0008  meas_in_a_loss=0.0177  comms_b_loss=0.1536  shoot_loss=0.1382  comm_mag_loss=1.4208  comm_mag_loss_raw=142.0768  mean_abs_comm_for_b=11.1237  meas_mag_loss=4.6614  meas_mag_loss_raw=466.1448  mean_abs_meas_in_a=19.7322  comm_mag_beta_target=1.0000  w_comm_mag=0.0100  w_meas_mag=0.0100  lr_a=0.0001  lr_b=0.0002  meas_in_a_per_0=0.0000  meas_in_a_per_1=0.0179  meas_in_a_per_2=0.0284  meas_in_a_per_3=0.0245  comms_b_per_0=0.1376  comms_b_per_1=0.1699  comms_b_per_2=0.1532
# Stage learning rates -> lr_a=9.999999747378752e-05 lr_b=0.00019999999494757503
# epoch 078  total=0.1411  shoot_acc=0.9995  comm_a_loss=0.0096  meas_in_a_loss=0.0448  comms_b_loss=0.0287  shoot_loss=0.0020  comm_mag_loss=0.0104  comm_mag_loss_raw=1.0444  mean_abs_comm_for_b=1.7459  meas_mag_loss=0.0455  meas_mag_loss_raw=4.5535  mean_abs_meas_in_a=3.1170  comm_mag_beta_target=1.0000  w_comm_mag=0.0100  w_meas_mag=0.0100  lr_a=0.0001  lr_b=0.0002  meas_in_a_per_0=0.0433  meas_in_a_per_1=0.0450  meas_in_a_per_2=0.0477  meas_in_a_per_3=0.0434  comms_b_per_0=0.0631  comms_b_per_1=0.0168  comms_b_per_2=0.0063

# [weights] saved: model_a_best.weights.h5, model_b_best.weights.h5
# Early stopping criteria met at epoch 78.
# [log] flushed -> C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260310_170244.pkl 
# [weights] saved: model_a_epoch_0078_final.weights.h5, model_b_epoch_0078_final.weights.h5
# [weights] saved: model_a_latest.weights.h5, model_b_latest.weights.h5
# {'log_path': 'C:\\Users\\nly99857\\OneDrive - Philips\\SW Projects\\QSeaBattle\\WIP\\logs\\train_run_20260310_170244.pkl', 'epochs_recorded': 79, 'interrupted': False}

# early stopping also on raw:
            # if epoch_metrics["shoot_acc"] > 0.999 and epoch_metrics["meas_mag_loss_raw"] < 0.01:
...
# [weights] saved: model_a_latest.weights.h5, model_b_latest.weights.h5
# [log] flushed -> C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260310_181243.pkl
# [log] flushed -> C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260310_181243.pkl
# [weights] saved: model_a_epoch_1000_final.weights.h5, model_b_epoch_1000_final.weights.h5
# [weights] saved: model_a_latest.weights.h5, model_b_latest.weights.h5
# {'log_path': 'C:\\Users\\nly99857\\OneDrive - Philips\\SW Projects\\QSeaBattle\\WIP\\logs\\train_run_20260310_181243.pkl', 'epochs_recorded': 1000, 'interrupted': False}       
