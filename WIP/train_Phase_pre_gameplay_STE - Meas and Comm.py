...
# #
# Alpha = 0.1, mode=MODE_AB if (epoch%20 < 2) else MODE_B, meas and comms logits hardened in forward pass.
# Also harden meas next to comm. 
#
# [weights] loaded: model_a_step14.weights.h5, model_b_step14.weights.h5
# [log] run file: C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260317_154712.pkl
# Enable rollback:  False

# [epoch 0] Training mode: AB
# WARNING: All log messages before absl::InitializeLog() is called are written to STDERR
# W0000 00:00:1773758844.969026   38224 loop_optimizer.cc:934] Skipping loop optimization for Merge node with control input: pr_replay_b_3_1/assert_equal_1/Assert/AssertGuard/branch_executed/_39
# epoch 000  total=1.4572  shoot_acc=0.9204  comm_a_loss=0.0023  meas_in_a_loss=0.0082  comms_b_loss=0.1963  shoot_loss=0.2183  comm_mag_loss=0.9553  comm_mag_loss_raw=9552.9375  mean_abs_comm_for_b=78.1899  meas_mag_loss=0.0768  meas_mag_loss_raw=767.9825  mean_abs_meas_in_a=20.9887  comm_mag_beta_target=10.0000  w_comm_mag=0.0001  w_meas_mag=0.0001  lambda_harden=0.0000  lr_a*1000=0.0100  lr_b*1000=0.1000  meas_in_a_per_0=0.0009  meas_in_a_per_1=0.0009  meas_in_a_per_2=0.0066  meas_in_a_per_3=0.0242  comms_b_per_0=0.1780  comms_b_per_1=0.2026  comms_b_per_2=0.2083
#
...
# [weights] saved: model_a_latest.weights.h5, model_b_latest.weights.h5
# {'log_path': 'C:\\Users\\nly99857\\OneDrive - Philips\\SW Projects\\QSeaBattle\\WIP\\logs\\train_run_20260317_154712.pkl', 'epochs_recorded': 1000, 'interrupted': False}

#
#
#  corrected target for |logit| for meas to 10.0 (was 1.0) and started from step 2.
#
# [epoch 999] Training mode: B
# epoch 999  total=0.0787  shoot_acc=0.9815  comm_a_loss=0.0000  meas_in_a_loss=0.0003  comms_b_loss=0.0422  shoot_loss=0.0349  comm_mag_loss=0.0004  comm_mag_loss_raw=4.4343  mean_abs_comm_for_b=10.3591  meas_mag_loss=0.0008  meas_mag_loss_raw=7.8054  mean_abs_meas_in_a=10.8564  comm_mag_beta_target=10.0000  w_comm_mag=0.0001  w_meas_mag=0.0001  lambda_harden=0.0000  lr_a*1000=0.0100  lr_b*1000=0.1000  meas_in_a_per_0=0.0002  meas_in_a_per_1=0.0005  meas_in_a_per_2=0.0004  meas_in_a_per_3=0.0002  comms_b_per_0=0.0448  comms_b_per_1=0.0425  comms_b_per_2=0.0394

# [weights] saved: model_a_epoch_1000.weights.h5, model_b_epoch_1000.weights.h5
# [weights] saved: model_a_latest.weights.h5, model_b_latest.weights.h5
# [log] flushed -> C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260318_173419.pkl
# [log] flushed -> C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260318_173419.pkl    
# [weights] saved: model_a_epoch_1000_final.weights.h5, model_b_epoch_1000_final.weights.h5
# [weights] saved: model_a_latest.weights.h5, model_b_latest.weights.h5
# {'log_path': 'C:\\Users\\nly99857\\OneDrive - Philips\\SW Projects\\QSeaBattle\\WIP\\logs\\train_run_20260318_173419.pkl', 'epochs_recorded': 1000, 'interrupted': False}
