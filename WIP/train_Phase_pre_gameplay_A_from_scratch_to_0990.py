...
# Start with step 2 and lambda = 0.0, increase if performance above 99%
...
# Compared to earlier run (train_to_0999_WORKING.py), we have strong anchors
# # B comm anchors for levels 1..3 w_comms_b_123=[0.1, 0.1, 0.1],
# this was in train_to_0999_WORKING.py: w_comms_b_123=[0.02, 0.02, 0.02],
# 
# --> With strong achors we reach 0.9820 after 1000 epochs, lambda still 0
# PS C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle> & "C:/Users/nly99857/OneDrive - Philips/SW Projects/QSeaBattle/venvs/env_QSeaBattle/Scripts/python.exe" "c:/Users/nly99857/OneDrive - Philips/SW Projects/QSeaBattle/WIP/train_Phase_pre_gameplay_A_from_scratch_to_0990.py"
# [weights] loaded: model_a_step2.weights.h5, model_b_step2.weights.h5
# [log] run file: C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260313_175810.pkl
# Enable rollback:  False

# [epoch 0] Starting epoch with lambda_harden=0.0000
# WARNING: All log messages before absl::InitializeLog() is called are written to STDERR
# W0000 00:00:1773421107.023727   28840 loop_optimizer.cc:934] Skipping loop optimization for Merge node with control input: cond_6/StatefulPartitionedCall/cond_6_0/branch_executed/_352
...
# #
# [epoch 999] Starting epoch with lambda_harden=0.0000
# epoch 999  total=0.0728  shoot_acc=0.9820  comm_a_loss=0.0000  meas_in_a_loss=0.0000  comms_b_loss=0.0393  shoot_loss=0.0335  comm_mag_loss=0.0000  comm_mag_loss_raw=770.8282  mean_abs_comm_for_b=26.7332  meas_mag_loss=0.0000  meas_mag_loss_raw=1583.7412  mean_abs_meas_in_a=36.7555  comm_mag_beta_target=1.0000  w_comm_mag=0.0000  w_meas_mag=0.0000  lambda_harden=0.0000  lr_a=0.0001  lr_b=0.0002  meas_in_a_per_0=0.0000  meas_in_a_per_1=0.0000  meas_in_a_per_2=0.0001  meas_in_a_per_3=0.0000  comms_b_per_0=0.0458  comms_b_per_1=0.0381  comms_b_per_2=0.0340

# [weights] saved: model_a_epoch_1000.weights.h5, model_b_epoch_1000.weights.h5
# [weights] saved: model_a_latest.weights.h5, model_b_latest.weights.h5
# [log] flushed -> C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260313_193128.pkl
# [log] flushed -> C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260313_193128.pkl
# [weights] saved: model_a_epoch_1000_final.weights.h5, model_b_epoch_1000_final.weights.h5
# [weights] saved: model_a_latest.weights.h5, model_b_latest.weights.h5
# {'log_path': 'C:\\Users\\nly99857\\OneDrive - Philips\\SW Projects\\QSeaBattle\\WIP\\logs\\train_run_20260313_193128.pkl', 'epochs_recorded': 1000, 'interrupted': False}
# 
# --> try again with weaker anchors for B comms: w_comms_b_123=[0.02, 0.02, 0.02], and also print the learning rates in the logs to see if they are changing at all with the current lambda_harden=0 schedule (which they shouldn't be since lambda_harden is 0, but good to confirm that the logging is correct and that the learning rates are actually being updated in the optimizers when we change them via _apply_stage)
# --> Start at 11 (just generate trace with train_to_0999_WORKING.py, saved at around 98%)
# --> gets to 99% at lmbda = 0.95 but collapses to 93-94% for lambda = 1.0 and does not recover
# [weights] loaded: model_a_step11.weights.h5, model_b_step11.weights.h5
# [log] run file: C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260314_092418.pkl     
# Enable rollback:  False

# [epoch 0] Starting epoch with lambda_harden=0.0000
# WARNING: All log messages before absl::InitializeLog() is called are written to STDERR
# W0000 00:00:1773476672.343591   21188 loop_optimizer.cc:934] Skipping loop optimization for Merge node with control input: cond/StatefulPartitionedCall/cond_0/branch_executed/_292
# epoch 000  total=0.0824  shoot_acc=0.9817  comm_a_loss=0.0000  meas_in_a_loss=0.0001  comms_b_loss=0.0500  shoot_loss=0.0323  comm_mag_loss=0.0000  comm_mag_loss_raw=293.9483  mean_abs_comm_for_b=17.5099  meas_mag_loss=0.0000  meas_mag_loss_raw=878.8950  mean_abs_meas_in_a=28.0103  comm_mag_beta_target=1.0000  w_comm_mag=0.0000  w_meas_mag=0.0000  lambda_harden=0.0000  lr_a*1000=0.1000  lr_b*1000=0.2000  meas_in_a_per_0=0.0000  meas_in_a_per_1=0.0001  meas_in_a_per_2=0.0002  meas_in_a_per_3=0.0000  comms_b_per_0=0.0831  comms_b_per_1=0.0342  comms_b_per_2=0.0327
#
#
# [epoch 151] Starting epoch with lambda_harden=1.0000
# epoch 151  total=0.2488  shoot_acc=0.9357  comm_a_loss=0.0123  meas_in_a_loss=0.0030  comms_b_loss=0.1175  shoot_loss=0.1160  comm_mag_loss=0.0000  comm_mag_loss_raw=81.1079  mean_abs_comm_for_b=10.0010  meas_mag_loss=0.0000  meas_mag_loss_raw=836.3011  mean_abs_meas_in_a=25.1597  comm_mag_beta_target=1.0000  w_comm_mag=0.0000  w_meas_mag=0.0000  lambda_harden=1.0000  lr_a*1000=0.1000  lr_b*1000=0.2000  meas_in_a_per_0=0.0000  meas_in_a_per_1=0.0011  meas_in_a_per_2=0.0063  meas_in_a_per_3=0.0046  comms_b_per_0=0.1172  comms_b_per_1=0.1183  comms_b_per_2=0.1169

# [epoch 152] Starting epoch with lambda_harden=1.0000
# [train] interrupted by user.
# [log] flushed -> C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260314_092418.pkl
# [weights] saved: model_a_epoch_0152_interrupted.weights.h5, model_b_epoch_0152_interrupted.weights.h5
# [weights] saved: model_a_latest.weights.h5, model_b_latest.weights.h5
# {'log_path': 'C:\\Users\\nly99857\\OneDrive - Philips\\SW Projects\\QSeaBattle\\WIP\\logs\\train_run_20260314_092418.pkl', 'epochs_recorded': 152, 'interrupted': True}
#
#
# New experiment: 
# Put a magnitide loss on comm_logits (as they are geneatre by A, no processing): 
# Start from step 12 (epoch 50 previous run) and run for 100 epochs, then slowly increase lambda_harden from 0 to 1 over the next 100 epochs, and see if we can get to 99% shoot acc with a nonzero comm_mag_loss, and if that helps stabilize performance when we increase lambda_harden towards 1.0 compared to the prior experiment where we had no comm_mag_loss and saw a sharp drop in shoot acc when we switched to lambda_harden=1.0
# Stalls at 97.4%, reduce weight on magnitude and try again
...
def train(config: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        ...
        while epoch < EPOCHS:
            ...
            if epoch > 200 and epoch_metrics["shoot_acc"] > 0.99:
