...
# PS C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle> & "C:/Users/nly99857/OneDrive - Philips/SW Projects/QSeaBattle/venvs/env_QSeaBattle/Scripts/python.exe" "c:/Users/nly99857/OneDrive - Philips/SW Projects/QSeaBattle/WIP/train_Phase_pre_gameplay_A.py"
# [weights] loaded: model_a_step8.weights.h5, model_b_step8.weights.h5
...
# W0000 00:00:1773241415.239093   42836 loop_optimizer.cc:934] Skipping loop optimization for Merge node with control input: pr_replay_b_3_1/assert_equal_1/Assert/AssertGuard/branch_executed/_39
# epoch 000  total=0.1036  shoot_acc=0.9997  comm_a_loss=0.0102  meas_in_a_loss=0.0434  comms_b_loss=0.0007  shoot_loss=0.0008  comm_mag_loss=0.0035  comm_mag_loss_raw=0.3511  mean_abs_comm_for_b=1.5203  meas_mag_loss=0.0449  meas_mag_loss_raw=4.4916  mean_abs_meas_in_a=3.1179  comm_mag_beta_target=1.0000  w_comm_mag=0.0100  w_meas_mag=0.0100  lambda_harden=0.0000  lr_a=0.0001  lr_b=0.0002  meas_in_a_per_0=0.0433  meas_in_a_per_1=0.0435  meas_in_a_per_2=0.0436  meas_in_a_per_3=0.0433  comms_b_per_0=0.0002  comms_b_per_1=0.0011  comms_b_per_2=0.0008

# [epoch 407] Starting epoch with lambda_harden=1.0000
# epoch 407  total=1.0696  shoot_acc=0.9383  comm_a_loss=0.0102  meas_in_a_loss=0.0434  comms_b_loss=0.0743  shoot_loss=0.0868  comm_mag_loss=0.8100  comm_mag_loss_raw=81.0000  mean_abs_comm_for_b=10.0000  meas_mag_loss=0.0449  meas_mag_loss_raw=4.4916  mean_abs_meas_in_a=3.1179  comm_mag_beta_target=1.0000  w_comm_mag=0.0100  w_meas_mag=0.0100  lambda_harden=1.0000  lr_a=0.0001  lr_b=0.0002  meas_in_a_per_0=0.0433  meas_in_a_per_1=0.0435  meas_in_a_per_2=0.0436  meas_in_a_per_3=0.0433  comms_b_per_0=0.0460  comms_b_per_1=0.0895  comms_b_per_2=0.0873

# [epoch 408] Starting epoch with lambda_harden=1.0000
# [train] interrupted by user.
# [log] flushed -> C:\Users\nly99857\OneDrive - Philips\SW Projects\QSeaBattle\WIP\logs\train_run_20260311_160314.pkl
# [weights] saved: model_a_epoch_0408_interrupted.weights.h5, model_b_epoch_0408_interrupted.weights.h5
# [weights] saved: model_a_latest.weights.h5, model_b_latest.weights.h5
# {'log_path': 'C:\\Users\\nly99857\\OneDrive - Philips\\SW Projects\\QSeaBattle\\WIP\\logs\\train_run_20260311_160314.pkl', 'epochs_recorded': 408, 'interrupted': True}
