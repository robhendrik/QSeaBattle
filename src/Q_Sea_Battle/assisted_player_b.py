"""Assisted Player B using classical shared randomness.
...
class AssistedPlayerB(PlayerB):
    """Player B implementation using shared randomness resources.

    This player mirrors the hierarchical structure used by
    :class:`AssistedPlayerA`. It traces the position of the gun through
    the same stack of shared randomness boxes and collects one outcome
    ...
    def __init__(self, game_layout: GameLayout, parent: "AssistedPlayers") -> None:
        """Initialise an :class:`AssistedPlayerB` instance.
        ...
        from .assisted_players import AssistedPlayers  # type: ignore
    ...
    def decide(
        ...
        """Decide whether to shoot using shared randomness and communication.
