...
- The comm bit is updated by XOR'ing with the parity contribution of the PR-assisted
...
class PyrCombineLayerB(tf.keras.layers.Layer):
    ...
    Purpose:
        ...
        The comm update corresponds to "append the PR-assisted outcome at the odd
    ...
    def call(
        ...
        """Combine gun state, shared resource, and comm.
        ...
        # Gate PR-assisted outcomes by whether gun is at odd index in the pair, then take parity.
        gated = odd * sr
